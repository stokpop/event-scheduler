...
import nl.stokpop.eventscheduler.exception.PerfanaAssertionsAreFalse;
import nl.stokpop.eventscheduler.exception.PerfanaClientException;
...
public final class EventScheduler implements PerfanaCaller {
    ...
    EventScheduler(TestContext context, PerfanaConnectionSettings settings,
                   boolean assertResultsEnabled, EventBroadcaster broadcaster,
